...
import net.mcreator.holycrusade.entity.DemonEntity;
...
public class DemonRenderer extends MobRenderer<DemonEntity, LivingEntityRenderState, Modeldemon> {
	...
	private static final class AnimatedModel extends Modeldemon {
		...
		public void setupAnim(LivingEntityRenderState state) {
			...
			DemonEntity entity = state.getRenderData(ENTITY_KEY);
	...
	public static final ContextKey<DemonEntity> ENTITY_KEY = new ContextKey<>(Identifier.parse("holy_crusade:demon_entity"));

	@EventBusSubscriber(Dist.CLIENT)
	public static class EntityStateAdder {
		@SubscribeEvent
		private static void registerRenderStateModifiersEvent(RegisterRenderStateModifiersEvent event) {
			event.registerEntityModifier(DemonRenderer.class, (entity, state) -> state.setRenderData(ENTITY_KEY, entity));
		}
	}
}