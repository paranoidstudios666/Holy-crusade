...
import net.mcreator.holycrusade.procedures.RatPlayerCollidesWithThisEntityProcedure;
...
public class RatEntity extends PathfinderMob {
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("holy_crusade:ea"));
	}
	...
	public void playerTouch(Player sourceentity) {
		...
		RatPlayerCollidesWithThisEntityProcedure.execute(sourceentity);
	}
