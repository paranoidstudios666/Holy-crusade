...
public class Demon2Entity extends TamableAnimal {
	public final AnimationState animationState1 = new AnimationState();

	public Demon2Entity(EntityType<Demon2Entity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("holy_crusade:hurt_demon_chico"));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		return HolyCrusadeModEntities.DEMON_2.get().create(serverWorld, EntitySpawnReason.BREEDING);
	}
