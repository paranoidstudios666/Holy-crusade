...
import net.mcreator.holycrusade.procedures.EeeeeProcedure;

public class TemplemanEntity extends Monster {
	public final AnimationState animationState0 = new AnimationState();
	public final AnimationState animationState1 = new AnimationState();

	public TemplemanEntity(EntityType<TemplemanEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		EeeeeProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
