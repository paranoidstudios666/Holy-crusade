package net.mcreator.holycrusade;
...
import net.mcreator.holycrusade.init.*;
...
@Mod("holy_crusade")
public class HolyCrusadeMod {
	public static final Logger LOGGER = LogManager.getLogger(HolyCrusadeMod.class);
	public static final String MODID = "holy_crusade";

	public HolyCrusadeMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		if (ModList.get().isLoaded("curios")) {
			modEventBus.addListener(HolyCrusadeModCuriosCompat::registerCapabilities);
		}
		HolyCrusadeModSounds.REGISTRY.register(modEventBus);
		HolyCrusadeModBlocks.REGISTRY.register(modEventBus);
		HolyCrusadeModBlockEntities.REGISTRY.register(modEventBus);
		HolyCrusadeModItems.REGISTRY.register(modEventBus);
		HolyCrusadeModEntities.REGISTRY.register(modEventBus);
		HolyCrusadeModTabs.REGISTRY.register(modEventBus);
		HolyCrusadeModMenus.REGISTRY.register(modEventBus);
